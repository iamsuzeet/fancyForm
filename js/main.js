...
const questions = [
  ...
  {questions: 'Enter Your Email', pattern: /^\w+@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$/ },
...
//all field complete  - show hi end
function formComplete(){
  const h1 = document.createElement('h1');
  h1.classList.add('end');
  h1.appendChild(document.createTextNode(`Thanks ${questions[0].answer} You are registered and will get an email shorty`));
  setTimeout(() => {
